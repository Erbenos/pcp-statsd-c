...
sleep(0.1)
stdout, stderr, status = Open3.capture3("pminfo statsd.pmda.settings.verbose -f")
...
$stdout.flush
if err_count == 0
  puts "✔".green + " Option verbose is ok                  "
else 
  puts "✖".red + " Option verbose fails: " + err_count.to_s + "   "
end
